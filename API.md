...
- идентификатор клиента (hotdogsite)
- адрес клиента (hotdogs.club)
- логотип c размерами 128x128
- название клиента (Блоги про хот-доги)
- описание клиента (Как готовить хот-доги, где взять вкусную сосиску и булочку)
...
"dposspace": {
	...
	"ru": {
	  "title": "DPoS.space",
	  "description": "Сервисы от делегата @denis-skripnik"
	},
	"en": {
	  "title": "DPoS.space",
	  "description": "Services from the witness @denis-skripnik."
	}
}
```
